...
//		executor.setWaitForTasksToCompleteOnShutdown(paascloudProperties.getTask().getWaitForTasksToCompleteOnShutDown());
//		executor.setAwaitTerminationSeconds(paascloudProperties.getTask().getAWaitTerminationSeconds());
